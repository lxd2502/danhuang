...
exports.list = function(req,res){
	console.log("-----contr/dash.js--- list function")
...
exports.add = function(req,res){
	console.log("-----contr/dash.js--- add function")

	MovieCate.find({},function(err,cates){
			res.render('dashVideoAdd',
			{
				cates:cates,
				movie:{
					title:"",
...
exports.delete = function(req,res){
	console.log("-----contr/dash.js--- delete function")
...
exports.save = function(req,res){
	console.log("-----contr/dash.js--- save function")
